...
import { deleteManyUserAvatars } from "../../actions/delete-user-avatar";
...
export const DataTableTransitionWrapper = ({
  ...
  const handleDelete = () => {
    deleteManyUserAvatars(selected || []).then((data) => {
      if (data.error) {
